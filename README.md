...
- [x] 카테고리별 포스트 필터링
- [ ] 🚨 **[1순위]** 포스트 임시 저장 API (POST /api/posts/draft)
- [ ] 🚨 **[1순위]** 임시 저장 포스트 조회 API (GET /api/posts/drafts)
- [ ] 🚨 **[1순위]** 임시 저장 포스트 복구 API (GET /api/posts/drafts/:id/restore)
- [ ] 🚨 **[1순위]** 포스트 자동 저장 API (PATCH /api/posts/:id/autosave)
...
- [ ] ⚠️ **[2순위]** 마크다운 에디터 컴포넌트 (shadcn/ui 기반)
- [ ] ⚠️ **[2순위]** 실시간 프리뷰 기능
- [ ] 📈 **[3순위]** 이미지 업로드 기능
...
- [ ] 📈 **[3순위]** 어드민 대시보드 (/admin)
- [ ] ⚠️ **[2순위]** 포스트 관리 페이지 (/admin/posts)
- [ ] ⚠️ **[2순위]** 새 포스트 작성 페이지 (/admin/posts/new)
- [ ] ⚠️ **[2순위]** 포스트 수정 페이지 (/admin/posts/[id]/edit)
...
- [ ] ⚠️ **[2순위]** 포스트 작성/수정 페이지 내 카테고리/서브카테고리 즉석 생성 모달
